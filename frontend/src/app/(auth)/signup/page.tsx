    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-3xl w-full">
        ...
        <Link href="/signup/patient/step1" className="group w-full">
          <Card className="h-full border-cyan-200 hover:border-cyan-500 hover:shadow-lg transition-all duration-200 cursor-pointer">
            <CardHeader className="text-center pt-10">
              <div className="mx-auto w-20 h-20 bg-cyan-50 rounded-full flex items-center justify-center text-cyan-600 mb-6 group-hover:scale-110 transition-transform">
        ...
        <Link href="/signup/doctor/step1" className="group w-full">
          <Card className="h-full border-slate-200 hover:border-cyan-500 hover:shadow-lg transition-all duration-200 cursor-pointer">
            <CardHeader className="text-center pt-10">
              <div className="mx-auto w-20 h-20 bg-cyan-50 rounded-full flex items-center justify-center text-cyan-600 mb-6 group-hover:scale-110 transition-transform">
