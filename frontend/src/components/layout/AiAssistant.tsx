    ...
    try {
      const res = await fetch(API_URL, {
        ...
        headers: {
          ...
          // ✅ FIX 2: Ngrok Header
          // This tells Ngrok "I am a developer, let the JSON through"
          "ngrok-skip-browser-warning": "true"
        },
        body: JSON.stringify({ messages: newHistory }),
      });

      // ✅ FIX 3: Check for Errors BEFORE parsing JSON
      // This prevents the "string did not match expected pattern" crash
      if (!res.ok) {
      ...
      setMessages(prev => [...prev, { role: "assistant", content: `⚠️ I'm currently offline. Please check your connection.` }]);
    } finally {
      setLoading(false);
    }
  };
